...
/* Check cols */
if(isset($config['news'][$type]['show_gallery_list']) && $config['news'][$type]['show_gallery_list']==true)
{
    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="<?=$colRight?>">
                ...
                <?php } ?>
                <?php if(isset($config['news'][$type]['images1_list']) && $config['news'][$type]['images1_list'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Icon <?=$config['news'][$type]['title_main_list']?></h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
                    ...
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Icon hover <?=$config['news'][$type]['title_main_list']?></h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
