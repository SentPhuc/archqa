...
<section class="content">
	<form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
		...
		<?php if((isset($config['website']['debug-developer']) && $config['website']['debug-developer']) || $myPermissions==true) { ?>
		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				...
				<?php } ?>
				<div class="row">
					<?php if($myPermissions==true) { ?>
						<div class="form-group col-md-12">
							<label for="keyweb" class="d-inline-block align-middle mb-0 mr-2">Khóa/ Mở website:</label>
							<div class="custom-control custom-checkbox d-inline-block align-middle">
								<input type="checkbox" class="custom-control-input keyweb-checkbox" name="data[keyweb]" id="keyweb-checkbox" <?=(!isset($item['keyweb']) || $item['keyweb']==1)?'checked':''?>>
								<label for="keyweb-checkbox" class="custom-control-label"></label>
							</div>
						</div>
					<?php } ?>
				...
				<?php if(isset($config['setting']['toado_iframe']) && $config['setting']['toado_iframe'] == true) { ?>
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="data[options][linkmap]" id="linkmap" rows="5" placeholder="Link map"><?=htmlspecialchars_decode($options['linkmap'])?></textarea>
					</div>
				<?php } ?>
				<div class="form-group">
				...
				<div class="row">
					<div class="form-group col-md-3 col-sm-6">
						<label for="countpro">Phân trang sản phẩm home:</label>
						<input type="text" class="form-control" name="data[options][countpro]" id="countpro" placeholder="Phân trang sản phẩm home" value="<?=$options['countpro']?>">
					</div>
					<div class="form-group col-md-3 col-sm-6">
						<label for="countnews">Phân trang tin tức home:</label>
						<input type="text" class="form-control" name="data[options][countnews]" id="countnews" placeholder="Phân trang tin tức home" value="<?=$options['countnews']?>">
					</div>
					<div class="form-group col-md-3 col-sm-6">
						<label for="countpro1">Phân trang sản phẩm trong:</label>
						<input type="text" class="form-control" name="data[options][countpro1]" id="countpro1" placeholder="Phân trang sản phẩm trong" value="<?=$options['countpro1']?>">
					</div>
					<div class="form-group col-md-3 col-sm-6">
						<label for="countnews1">Phân trang tin tức trong:</label>
						<input type="text" class="form-control" name="data[options][countnews1]" id="countnews1" placeholder="Phân trang tin tức trong" value="<?=$options['countnews1']?>">
					</div>
				</div>
