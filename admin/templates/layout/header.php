...
<nav class="main-header navbar navbar-expand navbar-white navbar-light text-sm">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item nav-item-hello d-sm-inline-block">
            <a class="nav-link"><span class="text-split">Xin chào, <?=(isset($_SESSION[$login_admin]['name']))?$_SESSION[$login_admin]['name']:$_SESSION[$login_admin]['username']?>!</span></a>
        </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu-info" class="dropdown-menu dropdown-menu-right border-0 shadow">
                <?php if(($config['website']['debug-developer'] && count($config['website']['lang']) >= 2) || $myPermissions==true) { ?>
                    <li>
