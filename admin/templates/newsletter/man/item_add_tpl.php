        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group-category row">
                    <?php if(isset($config['newsletter'][$type]['source']) && $config['newsletter'][$type]['source'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label for="source">Nơi đăng ký:</label>
                            <input type="text" class="form-control" name="data[source]" id="source" placeholder="Nơi đăng ký" value="<?=@$item['source']?>">
                        </div>
                    <?php } ?>
                    <?php if(isset($config['newsletter'][$type]['qty']) && $config['newsletter'][$type]['qty'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label for="qty">Số lượng:</label>
                            <input type="text" class="form-control" name="data[qty]" id="qty" placeholder="Số lượng" value="<?=@$item['qty']?>">
                        </div>
                    <?php } ?>
                    ...
                    <?php } ?>
                    <?php if(isset($config['newsletter'][$type]['city']) && $config['newsletter'][$type]['city'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label for="city">Thành phố:</label>
                            <input type="text" class="form-control" name="data[city]" id="city" placeholder="Thành phố" value="<?=@$item['city']?>">
                        </div>
                    <?php } ?>
                    <?php if(isset($config['newsletter'][$type]['district']) && $config['newsletter'][$type]['district'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label for="district">Quận/Huyện:</label>
                            <input type="text" class="form-control" name="data[district]" id="district" placeholder="Quận/Huyện" value="<?=@$item['district']?>">
                        </div>
                    <?php } ?>
